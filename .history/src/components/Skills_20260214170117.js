          ...
          <Grid2 key={index} size={{ 
            ...
            <Paper elevation={3}
              ...
              <Typography variant="h6" sx={{ 
                    fontWeight: 500,
                    whiteSpace: 'normal',          // allow wrapping (overrides any nowrap)
                    overflowWrap: 'break-word',    // break very long words if necessary
                    hyphens: 'auto',               // add soft hyphens (good for "MaterialUI")
                    wordBreak: 'break-all',        // aggressive fallback — use only if needed
                    }}>
                  {skill.skill}
              </Typography>
            </Paper>
