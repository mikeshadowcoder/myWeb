          ...
          <Grid2 key={index} size={{ 
            ...
            <Paper elevation={3}
              ...
              <Box component="img" 
                ...
                sx={{ 
                  width: { 
                    xs: 60,           // your current mobile size — unchanged
                    sm: 70,           // your current tablet-ish size — unchanged
                    md: 90,           // bigger on laptops (900px+)
                    lg: 110,          // even larger on wide desktops (1200px+)
                    xl: 130           // optional: maximum size on ultra-wide (1536px+)
                  },          
                  height: { 
                    xs: 60,
                    sm: 70,
